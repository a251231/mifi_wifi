    ...
    if (menuName === '#msg') {
        ...
        switch (menuName) {
            ...
            case '#vnstat':
                ...
                // clearInterval(ussdIntervalId);
                // clearTimeout(resetNetworkStatusTimeoutId);
                document.getElementById("network_vnstat").className = "network_menu_select";
                document.getElementById("nmvnstat").className = "network_menu_text_select";
                document.getElementById("vnstat").style.display = "block";
                vnstat_get();
                vnstat();
                break;
            case '#sm':
...
function checkStatusNormal() {
    ...
    document.getElementById("network_vnstat").className = "network_menu_normal";
    ...
    document.getElementById("nmvnstat").className = "network_menu_text_normal";
...
function hideNetworkRight() {
    ...
    document.getElementById("vnstat").style.display = "none";
...
function vnstat(){
    $.ajax({                                                                                                                                                                                                                                                                            
            url: "/api/vnstat?cmd_type="+$("#nvnstat_Type").val(),                                                                                                                                                                                                                                                                       
	    type:"POST",                                                                                                                                                                                                             
            success: function (data) {                                                                                                                                                                                                                                                       
                $("#vnstat_result").html(data);                                                                                                                                                                                                                                                                  
            }
        }) 
}
function vnstat_get(){
    $.ajax({                                                                                                                                                                                                                                                                            
	    ...
	    type:"POST",                                                                                                                                                                                                             
            success: function (data) {                                                                                                                                                                                                                                                     
                if (data.state === 1) {   
                    if(data.is_vnstat){
                        $('#network_vnstatEnable').attr( "checked", 'true');
                        $('#network_vnstatEnable').parent().find('em').text('ON');
                        $('#network_vnstatEnable').parent().find('div').addClass("layui-form-onswitch")
                    }else{
                        $('#network_vnstatEnable').removeAttr("checked");
                        $('#network_vnstatEnable').parent().find('em').text('OFF');
                        $('#network_vnstatEnable').parent().find('div').removeClass("layui-form-onswitch")
                    }
                }                                                                                                                                                                                                                                                       
            }
        }) 
...
function vnstat_set(){
    $.ajax({                                                                                                                                                                                                                                                                            
            url: "/api/vnstat_set?"+$("#network_vnstatEnable").val(),                                                                                                                                                                                                                                                                       
            dataType: "json", 
	    type:"POST",                                                                                                                                                                                                             
            success: function (data) {                                                                                                                                                                                                                                                     
                if (data.state === 1) {                                                                                                                                                                                                                                                          
...
layui.use(['form'], function() {
         form=layui.form;
         form.on('select(nvnstat_Type)', function(data){   
              var val=data.value;
              console.info(val);
            vnstat();
                       });
         form.on('switch(nvnstat_state)', function(data){   
             console.log(data.value);
             var is_vnstat = 0;
              if($('#network_vnstatEnable').is(":checked")){
                  is_vnstat = 1;
              }
              $.ajax({                                                                                                                                                                                                                                                                            
                    url: "/api/vnstat_set?is_vnstat="+is_vnstat,                                                                                                                                                                                                                                                                       
                    dataType: "json", 
                    type:"POST",                                                                                                                                                                                                             
                    success: function (data) {                                                                                                                                                                                                                                                     
                        if (data.state === 1) {                                                                                                                                                                                                                                                          
