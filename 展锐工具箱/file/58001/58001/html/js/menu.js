...
function setSettingsText() {
    ...
    document.getElementById("text_menu_advanced").innerHTML = I18N("j", "smAdvanced");
    ...
    document.getElementById("setting_menu_imei").style.display = DISPLAY_IMEI;
...
function batinfoajax() {
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById("bat_status").innerHTML = data.STATUS;
            document.getElementById("bat_health").innerHTML = data.HEALTH;
            document.getElementById("bat_voltage_now").innerHTML = data.VOLTAGE_NOW / 1000 + " mV";
            document.getElementById("bat_voltage_avg").innerHTML = data.VOLTAGE_AVG / 1000 + " mV";
            document.getElementById("bat_capacity").innerHTML = data.CAPACITY + " %";
            document.getElementById("bat_full").innerHTML = data.CHARGE_FULL + " uAh";
            document.getElementById("bat_charge_current").innerHTML = data.CONSTANT_CHARGE_CURRENT / 1000 + " mA";
            document.getElementById("bat_current_limit").innerHTML = data.INPUT_CURRENT_LIMIT / 1000 + " mA";
            document.getElementById("bat_current_now").innerHTML = data.CURRENT_NOW / 1000 + " mA";
            document.getElementById("bat_current_avg").innerHTML = data.CURRENT_AVG / 1000 + " mA";
            document.getElementById("bat_charge_count").innerHTML = data.CHARGE_COUNTER + " uAh";
            document.getElementById("bat_online").innerHTML = parseInt(data.ONLINE) ? "USB供电" : "电池供电";
            document.getElementById("bat_temp").innerHTML = data.TEMP / 10 + " ℃";
        }
    });
}
var showbatajax_id;
...
function disable_charge() {
    var disable_charge = 0;
    if ($('#disable_charge').is(":checked")) {
        disable_charge = 1;
    }
    $.ajax({
        type: "GET",
        url: "/api/batw?disable_charge=" + disable_charge,
        dataType: "json",
        success: function (data) {
            if (data.state === 1) {
            } else {
