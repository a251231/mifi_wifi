...
function checkSettingMenuIcon(menuName) {
    ...
    if (menuName === "settings_menu_router") {
        ...
        mm_getXMLCfg("timestatus", systemTimeGet);
        ...
        mm_getXMLCfg("getPortInfo", getPortInfo);
...
function checkSettingMenu2Icon(menuName) {
    ...
    switch (menuName) {
        ...
        case "internet_menu_Qos":
            ...
            mm_getXMLCfg("qosLimitGet", setQosValue);
            break;
        ...
        //     mm_getXMLCfg("macFilterGet", macFilterGet);
        //     break;
        // case "wifi_menu_WPS" :
        ...
        case "firewall_menu_mac":
            ...
            mm_getXMLCfg("macfilterslist", firewallMacFilterGet);
            break;
        case "firewall_menu_ip":
            ...
            mm_getXMLCfg("ipFilterGet", firewallIpFilterGet);
            break;
        case "firewall_menu_url":
            ...
            mm_getXMLCfg("urlFilterGet", firewallUrlFilterGet);
            break;
        case "firewall_menu_advanced":
            ...
            mm_getXMLCfg("antiDdosGet", antiDdosGet);
            break;
        ...
        case "system_menu_internet_time":
            ...
            document.getElementById("system_internet_time").style.display = "block";
            mm_getXMLCfg("timestatus", systemTimeGet);
            systemTimeTimeoutId = setInterval('setTimeout("mm_getXMLCfg(\'timestatus\', systemTimeGet)",0)', 1000 * 60);
            break;
        case "system_menu_system_log":
            ...
            mm_getXMLCfg("systemLogGet", systemLogGet);
            break;
...
function detectVersion() {
    mm_getXMLCfg("checkNewVersion", getUploadValue);
}
...
function OnRebootOK() {
    ...
    if (confirm(I18N("j", "confirmLAN"))) {
        mm_getXMLCfg("reset", rebootOK_callback);
    }
}
...
function PowerOffOK() {
    ...
    if (confirm(I18N("j", "confirmShut"))) {
        mm_getXMLCfg("power_off", powerOffOK_callback);
    }
}
...
function OnRecoveryOK() {
    mm_getXMLCfg("recovery_system", recovery_callback);
}
...
function localupdateStarted() {
    mm_getXMLCfg("otaUpdate", local_update);
}
...
function getPortInfo() {
    ...
    mm_getXMLCfg("getPortInfo", port_callback);
}
